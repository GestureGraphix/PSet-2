...
\sol{ 
	...
	\begin{center}
		...
		\[ 50000(800) - 200(800)\sqrt{800} = 35,474,516.6004 \text{ ears of corn} \] 
	\end{center}
	(b) \\
	$f(x) = 50 - 0.3 \sqrt{x}$ \\
	...
	\begin{center}
		...
		\[2 \pi \int_{0}^{80} 50x - 0.3x \sqrt{x} dx = \left(50 \pi x^{2} - \frac{6 \pi x^{2}\sqrt{x}}{25}\right) \Big|_{0}^{80}\] 
		\[ 50 \pi \cdot 80^{2} - \frac{6 \pi \cdot 80^{2}\sqrt{80}}{25} - \left(50 \pi \cdot 0^{2} - \frac{6 \pi \cdot 0^{2}\sqrt{0}}{25}\right) \approx 962149.1874 \text{ ears of corn }\] 
	\end{center}
}
...
\sol{
	...
	\[ 320 \ln(x+10) \Big|_{0}^{25} = 320ln(25+10) - 320 ln(0 + 10) \approx 400.884 \approx 401 \text{ raisins}\] 
...
\sol{
	...
	$ r_{i} = \sqrt{4 - (2-h)_{i}^2}$  \\
	raisins in $i^{th}$ slice = $\pi \left( \sqrt{4 - h_{i}^{2}} \right)^{2} \cdot \Delta h \cdot  5h$ 
	\begin{center}
		\[ \int_{0}^{4} (5h) \pi \left(4 - (2-h_{i})^{2} \right) dh \] 
		\[ \int_{0}^{4} (5h) \pi \left(4 - (2-h_{i})^{2} \right) dh = \left( \frac{20 \ pi x ^{3}}{3} - \frac{5 \pi x^{4}}{4} \right)\]
		\[ \frac{20 \pi \cdot 4^{3}}{3} - \frac{5 \pi \cdot 4^{4}}{4} - \left( \frac{20 \pi \cdot 0^{3}}{3} - \frac{5 \pi \cdot 0^{4}}{4}\right) = \frac{320 \pi }{3} \approx 335.103\text { mg of mineral}\]
	\end{center}
...
\sol {
	...
	\begin{center}
		\[ \int_{0}^{4} 2\pi x \frac{8}{1 + \frac{x^{2}}{16}} dx \] 
		\[ 16 \pi \int_{0}^{4} x \frac{1}{\frac{16 + x^{2}}{16}}\] 
		\[ 16 \pi \int_{0}^{4}  \frac{16x}{16 + x^{2}}\] 
		\[ 16 + x^{2} = t\]
		\[ 16 \pi \int_{0}^{4} \frac{8}{t} dt \]
		\[ 16 \pi \cdot 8 \ln(|t|) \] 
		\[ 16 \pi \cdot 8 \ln(|16 + x^{2}|) \] 
		\[ 128 \pi \cdot \ln(16 + x^{2}) \Big|_{0}^{4} \]
		\[ 128 \pi \cdot \ln\left(16 + 4^{2} \right) - 128 \pi \cdot \ln\left(16 + 0^{2} \right) = 128 \pi \cdot \ln (2)\]  
		\[ 128 \pi \cdot ln (2) \approx 278.731 \text{ ft}^{3}\] 
	\end{center}
} 
...
\sol{
	...
	\begin{center}
		\[ W_{1} = \lim_{n \to \infty} \sum^{n}_{i=1} 3 x_{i} \Delta x \] 
		\[ \int_{0}^{25} 3x dx = \frac{3}{2}x^{2} \Big|_{0}^{25} \] 
		\[ \frac{3}{2}x^{2} \Big|_{0}^{25} = \frac{3}{2}(25)^{2} = 937.5\] 
		\[ W_{2} = \int_{25}^{40} 3x dx = 2100\] 
		\[ W_{1} + W_{2} = 3562.5 \text{ft. lbs.} \]  
	\end{center}
	(b) 
	\begin{center}
		\[ w = 180 - 3x \] 
		\[ W = \int_{25}^{60} 3 \left( 25 \right) dx\] 
		\[ W = \int_{0}^{25} 180 - 3x dx = 3562.5 \text{ft. lbs.} \]  
	\end{center}
...
\sol{
	...
	Density: $1000 \frac{kg}{mg^{3}}$ \\
	Work is the distance traveled times the amount of water moved\\
	Weight: $(1000kg)(\pi (9 - (3- h_{i})^{2}) \Delta h)(9.8)$
	\begin{center}
		\[ r_{i}^{2} = 3^{2} - h_{i}^{2}\] 
		\[ r_{i} = \sqrt{3^{2} - h_{i}^{2}} \]
		\[ W = (1000kg)(\pi (9 - (3- h_{i})^{2}) \Delta h)(9.8) (1 + h_{i})\] 
		\[ \int_{0}^{6} (1000kg)(\pi (9 - (3- h)^{2})(1+h))(9.8) dh \approx 1411200 \pi  J \] 
	\end{center}
...
\sol{ 
	...
	\begin{center}
		...
		\[ 1250 \int_{0}^{6} 6x - x^{2} dx \] 
		\[ 1250 \left(3x^{2} - \frac{1250 x^{3}}{3}\right) = \left(3750 x^{2} - \frac{1250 x^{3}}{3}\right)\Big|_{0}^{6}\]
		\[ \left(3750 x^{2} - \frac{1250 x^{3}}{3}\right)\Big|_{0}^{6} = 45000 \text{ft. lbs.}\]  
	\end{center}
