...
\sol{ 
	...
	\begin{center}
		...
		\[ 50 \pi \cdot 80^{2} - \frac{6 \pi \cdot 80^{2}\sqrt{80}}{25} - \left(50 \pi \cdot 0^{2} - \frac{6 \pi \cdot 0^{2}\sqrt{0}}{25}\right) \approx 962149.1874 ears of corn \] 
	\end{center}
}
...
\sol{
	...
	\begin{center}
		...
		\[ \frac{20 \pi \cdot 4^{3}}{3} - \frac{5 \pi \cdot 4^{4}}{4} - \left( \frac{20 \pi \cdot 0^{3}}{3} - \frac{5 \pi \cdot 0^{4}}{4}\right) = \frac{320pi }{3} \approx 335.103\text { mg of mineral}\]
	\end{center}
...
\sol {
	...
	\begin{center}
		...
		\[ 128 \pi \cdot ln (2) \approx 278.731\] 
	\end{center}
} 
...
\sol{
	...
	\begin{center}
		...
		\[ W = \int_{0}^{25} 180 - 3x dx = 3562.5 J\]  
	\end{center}
...
\sol{ 
	...
	\begin{center}
		...
		\[ \left(3750 x^{2} - \frac{1250 x^{3}}{3}\right)\Big|_{0}^{6} = 45000\]  
	\end{center}
