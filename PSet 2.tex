...
\sol{ 
	...
	\begin{center}
		...
		\[ 50 \pi x^{2} - \frac{3 \pi x^{2} \sqrt{x}}{25} \Big|_{0}^{80} =  983,729.4183 \text{ ears of corn}\] 
	\end{center}
}
...
\sol{
	...
	\begin{center}
		...
		\[ \int_{25}^{40} 3x dx = 2100\] 
		\[ W = \text{weight * height }\]
		\[ W = 25 \cdot 3 \cdot 12.5 = 937.5 \]
		\[ Ans = 3562.5\]  
	\end{center}
	(b) 
	\begin{center}
		\[ w = 180 - 3x \] 
		\[ W_{2} = \int_{25}^{60} 3 \left( 25 \right) dx\] 
		\[ W_{2} = \int_{25}^{60} 75x \space dx \] 
		\[ W_{2} = \left[ 75 x \right]^{60}_{25}\] 
		\[ = \left[ 75 \left( 60 \right) - 75 \left( 24 \right) \right] = 2625\] 
		\[ W_{1} + W_{2} = 3562.5 \text{ft} \] 
	\end{center}
